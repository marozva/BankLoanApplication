...
public class ProfileServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //String annual = request.getParameter("ai");
        String month = request.getParameter("mi");
        int ann = Integer.parseInt(month);
        int annual = ann * 12;
        ...
        try{
            ...
            int i= stmt.executeUpdate("insert into income (accountno,annual,monthly) values ('"+num+"','"+annual+"','"+month+"')");
            if(i>0){
