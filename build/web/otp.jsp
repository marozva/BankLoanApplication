<%-- 
    Document   : otp
    Created on : 24 Jan, 2017, 11:51:39 AM
    Author     : BALA
--%>
...
<div class="login-block">
    ...
    <!-- <input type="hidden" value="<%=request.getParameter("accountno")%>" name="accountnum"> -->
    <input type="text" placeholder="OTP" name="otp"/>
    <center><button  style="background-color:#ae275f;"class="btn waves-effect waves-light " type="submit" name="">SUBMIT</button></center>
    </form>
</div>
</body>
</html>
